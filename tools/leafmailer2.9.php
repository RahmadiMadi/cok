...
print '
<head>
    <title>'.str_replace("www.", "", $_SERVER['HTTP_HOST']).' - M4DI~UciH4 PHPMailer</title>
...
print '<div class="container col-lg-6">
        <h3><font color="green"><span class="glyphicon glyphicon-leaf"></span></font> M4DI~UciH4 PHPMailer <small>'.$leaf['version'].'</small></h3>
